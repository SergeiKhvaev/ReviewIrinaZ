...
Create objects of all three to see which variables and methods each object
has access to
     */
    ...
    public Employee(String name, boolean isFullTime, double salary){// regular constructor for Super class
        this.name = name;
